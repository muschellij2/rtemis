...
#' exceeds this number. i.e. if set to .9 and `minimize = TRUE`, if there is a 90\% drop from `x[1]` to 
...
#' @param combine.relative.thresholds String: "AND" or "OR": How to combine the criteria `relative.threshold` and
...
#' @param na.response String: "stop" or "continue": what should happen if the last value of `x` is `NA`
#' @param verbose Logical: If TRUE, print messages to output
#' @return List with the following items:
#' \item{last.value}{Float: Last value of `x`}
#' \item{relativeVariance}{Float: relative variance of last `n.steps`}
