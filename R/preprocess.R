...
#' random forest regression. "rfImpute" uses `randomForest::rfImpute` (see its documentation), "meanMode" will use
#' mean and mode by default or any custom function defined in `impute.discrete` and `impute.numeric`
#' @param impute.discrete Function that returns single value: How to impute discrete variables for 
#' `impute.type = "meanMode"`. Default = [getMode]
