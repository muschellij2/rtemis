...
#' Robust linear model
#'
#' Convenience alias for `s.LM(robust = T)`. Uses `MASS::rlm`
#'
#' @inheritParams s.GLM
...
#' #'
#' #' Convenience alias for `s.LM(gls = T)`. Uses `MASS::lm.gls`
#' #'
#' #' GLS can be useful in place of a standard linear model, when there is correlation among
#' #'   the residuals
#' #' @inheritParams s.GLM
#' #' @param ... Additional parameters to be passed to `MASS::lm.gls`
#' #' @export
#'
