...
#' @param autotune Logical: If TRUE, use ]code{randomForest::tuneRF} to determine `mtry`
...
#' `verbose = TRUE`
#' @param tune.do.trace Same as `do.trace` but for tuning, if `autotune = TRUE`
#' @param imetrics Logical: If TRUE, calculate interpretability metrics (N of trees and N of nodes) and save under
#' the 'extra' field of [rtMod]
#' @param print.tune.plot Logical: passed to `randomForest::tuneRF`. Default = FALSE
