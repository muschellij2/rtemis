...
#' To plot histograms of multiple groups, it's best to use `hist.type = "lines"`, which will use [mhist]
...
#'   Case-insensitive and supports partial matching: e.g. `mplot3.x(x, "H")` gives histogram
...
#' @param lwd Integer: Line width. Used for `type = "line" or "density"`
...
#' @param density.shade Logical: If TRUE, draw shaded polygon for `type = "density"`. Default = TRUE
#' @param qqline.col Color for Q-Q line
#' @param qqline.alpha Float: Alpha for Q-Q line
#' @param density.mean Logical: If TRUE, print mean of `x` along plot. Default = TRUE, for `type = "density"`
...
#' @seealso [mplot3], [mplot3.xy], [mplot3.xym], [mplot3.heatmap]
