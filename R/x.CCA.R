...
#'
#' #' `x.CCA` runs `PMA::CCA`. If penaltyx is NULL, penaltyx *and* penaltyz will be estimated automatically
...
#' @param outcome String: Type of outcome `y`: "survival", "multiclass", "quantitative"
...
#' @param typez String: "standard", "ordered". Same as `typex` for z dataset
...
#' @param verbose Logical: Print messages, including `trace` from `x.CCA.permute` and
#' `PMA::CCA`
