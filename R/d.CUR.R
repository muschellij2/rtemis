...
#'
#' Note that `k` here does not correspond with `k` in the other decomposition functions.
...
#' CUR approximation is returned. Effective only if `matrix.return = TRUE`. Default = FALSE
