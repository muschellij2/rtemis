...
<!-- badges: start -->
[![Build Status](https://travis-ci.com/egenn/rtemis.svg?branch=master)](https://travis-ci.com/egenn/rtemis)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/egenn/rtemis?branch=master&svg=true)](https://ci.appveyor.com/project/egenn/rtemis)
<!-- badges: end -->
